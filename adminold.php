        ...
        <div class="main-wrapper">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="" style="font-size: 30px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><i style="font-size: 30px;" class="fas fa-graduation-cap"></i> |
                                Learnify <sup>3</sup></a>
                        </div>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="">LY <sup>3</sup></a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i>
                                <span>Materi</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="">Data Materi</a>
                                </li>
                                <li><a class="nav-link" href="">Tambah Materi</a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="">
                        <div class="hero text-white hero-bg-image" data-background="assets/stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">

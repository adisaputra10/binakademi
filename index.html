    ...
    <div class="banner_inner d-flex align-items-center">
        ...
        <div class="container">
            <div class="banner_content text-center">
                <h3 data-aos="fade-up" data-aos-duration="1600">BOOTCAMP ONLINE</h3>
                <p data-aos="fade-up" data-aos-duration="1900">adalah program belajar pemrograman online yang dilakukan secara intensif, hanya dalam 1 platform dengan 1x pembayaran
                
                Dengan Learnify kemudahan kegiatan belajar mengajar dapat terpenuhi. Para guru dan siswa dapat
                ...
                <a data-aos="fade-up" data-aos-duration="2000" class="main_btn" href=" #registration">Bergabung Sekarang <span class="lnr lnr-arrow-right"></span></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <img data-aos="fade-up" data-aos-duration="1800" src="assets/img/illustrations/index-study.svg" alt="" srcset="">
            </div>
        </div>
        <div class="row">
                ...
                <div class="testi_slider owl-carousel">
                    <div class="item">
                        <div class="testi_item">
                            <img src="assets/img/testimonials/testi-3.png" alt="">
...
<section class="impress_area p_120">
    <div class="container">
        <div class="impress_inner text-center">
            ...
            <a data-aos="fade-up" data-aos-duration="2200" class="main_btn" href="">Login Sebagai Guru <span class="lnr lnr-arrow-right text-black"></span></a>
        </div>
    </div>
</section>
<!--================End Impress Area =================-->
        ...
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href=" ">Tentang Learnify</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <img src="assets/img/modal-login-2.png" class="img-fluid img-responsive mx-auto " style="height: 350px;">
                        </div>
                        <div class=" col-md-6">
